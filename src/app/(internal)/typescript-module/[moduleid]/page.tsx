...
interface TypescriptModuleDetailsProps {
  params: {
    moduleid: string;
  };
}

const TypescriptModuleDetails = ({ params }: TypescriptModuleDetailsProps) => {
  const modules = TypescriptModules.find((mod) => mod.id === params.moduleid);
  {
    console.log(modules);
  }
